...
class UserService(private val userRepo: UserRepository) {
    ...
    suspend fun getById(id: Int) = userRepo.getById(id)

    suspend fun getUser(externalUserid: String, accountType: AccountType) =
        userRepo.getByUsername(getUsername(externalUserid, accountType))
